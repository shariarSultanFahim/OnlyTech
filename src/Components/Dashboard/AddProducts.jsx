        ...
        <div className="hero-content flex-row-reverse w-full">
            ...
            <form className="card-body bg-primaryColor rounded-lg" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-control lg:w-5/12" >
                     {
                      (imageUpload)?
                        ...
                        :
                      <input {...register("productImg")} type="text" name="productImg" className="input input-bordered bg-secendaryColor" placeholder="image url" required />
                     }
                </div>
               ...
               <div className="form-control w-full">
                ...
                <button type="submit" className="btn mx-auto">Add</button>
            </form>
            </div>
        </div>
